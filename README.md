...
```groovy
debugImplementation 'com.snakyapps.watchtower:interceptor-okhttp:2.0.0-rc1'
releaseImplementation 'com.snakyapps.watchtower:interceptor-okhttp-no-op:2.0.0-rc1' // no-op dependency for non-debug build variants
```
...
```groovy
debugImplementation 'com.snakyapps.watchtower:android:2.0.0-rc1'
releaseImplementation 'com.snakyapps.watchtower:android-no-op:2.0.0-rc1' // no-op dependency for non-debug build variants
```
