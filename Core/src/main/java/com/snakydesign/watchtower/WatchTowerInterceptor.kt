 ...
 */
class WatchTowerInterceptor @JvmOverloads constructor(private vararg val networkEventLoggers: WatchTower, @Volatile private var level: LogLevel = LogLevel.FULL) :
    Interceptor {
